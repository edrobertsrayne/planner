<!--
	...
	account controls), with the Calendar tab active. The variants are judged inside it because a
	screen's density only reads honestly against the chrome that will surround it.
-->
<script lang="ts">
		...
		<div class="flex items-center gap-6 px-6 pt-4">
			...
			<nav class="flex flex-1 gap-1">
				{#each TABS as tab (tab)}
					<span
						class="-mb-px border-b-2 px-3 py-2 text-sm font-medium {tab === 'Calendar'
