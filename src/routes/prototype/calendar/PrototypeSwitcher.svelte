<!--
	PROTOTYPE — throwaway. Floating bar, three axes, because #69 asks three separable questions:
	the grid's shape (`variant`), how much of the tone a cell wears (`class`), and whether both
	halves of the Teaching Week belong on screen at once (`weeks`). Theme is the app's own toggle
	in the header, so it isn't an axis here.
-->
<script lang="ts">
...
>
	{@render pills(CUES, cue, 'class', 'How a Class is distinguished')}
	{@render pills(WEEKS, weeks, 'weeks', 'How much of the Teaching Week is shown')}
