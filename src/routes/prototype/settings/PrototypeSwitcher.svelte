<!--
	PROTOTYPE — throwaway. Floating bar, three axes, because #80 asks two separable questions and
	needs a third control to exercise them: the screen's shape (`variant`), where the result of the
	submit lands (`feedback`), and which result the stubbed action returns (`outcome`).
-->
<script lang="ts">
